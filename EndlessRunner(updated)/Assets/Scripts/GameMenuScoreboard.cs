...
public class GameMenuScoreboard : MonoBehaviour {
    ...
    IEnumerator Start()
    {
        ...
        else
        {
            ...
            getScores1URL = "https://easel1.fulgentcorp.com/bifrost/ws.php?json=[{%22action%22:%22run_sql%22},{%22query%22:%22SELECT%20*%20FROM%20HighScores%20WHERE%20MapName%20=%20%27Desert%27%20ORDER%20BY%20HighScores.Score%20DESC%20LIMIT%200,3%22},{%22session_key%22:%22" + loginMsg[3]["session_key"].ToString() + "%22}]";
            ...
            // concatenates mySQL call with session key from login request
            getScores2URL = "https://easel1.fulgentcorp.com/bifrost/ws.php?json=[{%22action%22:%22run_sql%22},{%22query%22:%22SELECT%20*%20FROM%20HighScores%20WHERE%20MapName%20=%20%27Cave%27%20ORDER%20BY%20HighScores.Score%20DESC%20LIMIT%200,3%22},{%22session_key%22:%22" + loginMsg[3]["session_key"].ToString() + "%22}]";
            ...
            // concatenates mySQL call with session key from login request
            getScores3URL = "https://easel1.fulgentcorp.com/bifrost/ws.php?json=[{%22action%22:%22run_sql%22},{%22query%22:%22SELECT%20*%20FROM%20HighScores%20WHERE%20MapName%20=%20%27UTSA%27%20ORDER%20BY%20HighScores.Score%20DESC%20LIMIT%200,3%22},{%22session_key%22:%22" + loginMsg[3]["session_key"].ToString() + "%22}]";
